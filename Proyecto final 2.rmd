...
ggplot(data=df_final) + geom_point(aes(x=puntuacion,y=log(precio_euros),col=tipo_habitacion),size=1) + xlab("Puntuación")+ ylab('Precio (en Euros)')  +theme_bw()
...
df_2 %>% group_by(grupo_habitacion) %>% summarise(n())
