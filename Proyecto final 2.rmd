...
```{r message=FALSE,warning=FALSE,echo=FALSE,fig.cap="Histograma de la variable de respuesta precio_euros",results='asis', fig.align='center'}
...
```{r fig.cap="Histograma de los Residuos Studentizados",results='asis', fig.align='center',echo=FALSE,message=FALSE,warning=FALSE,results='asis'}
