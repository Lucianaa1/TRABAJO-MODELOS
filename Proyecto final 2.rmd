...
A continuación del estudio del anova, se volvieron a realizar las pruebas de diagnóstico con el nuevo modelo. No se obtuvieron resultados muy diferentes a los que ya se tenían, excepto de la última prueba, donde se calculó nuevamente la distancia de cook y se encontraron nuevas observaciones atípicas que fueron eliminadas obteniendo así un nuevo modelo, mod2. Esta última prueba se verá en el siguiente script.
