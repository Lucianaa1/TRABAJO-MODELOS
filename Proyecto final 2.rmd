...
```{r message=FALSE,echo=FALSE, warning=FALSE,fig.cap="Dispersión de Precio (en euros) según la puntuación, por tipo de alojamiento", results='asis'}
...
```{r}
#RESOLVER: PORNER EN FORMATO LINDO EL GRÁFICO
